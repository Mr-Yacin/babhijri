...
>
    <!-- Modal Content -->
    <div class="bg-white rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl animate-slideUp" dir="rtl">
        <!-- Close Button -->
        <button
            on:click={onClose}
        ...
        <div class="relative h-96 bg-gray-900">
                ...
                <div class="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2">
                    {#each profile.photos as _, index}
                        <button
                            ...
                            class="w-2 h-2 rounded-full transition-all {currentPhotoIndex === index ? 'bg-white w-8' : 'bg-white/50'}"
            ...
            <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-6 pt-20">
                <h2 class="text-white text-3xl font-bold flex items-center gap-2">
        ...
        <div class="p-6 space-y-6">
            ...
            {#if profile.interests && profile.interests.length > 0}
                <div>
                    <h3 class="text-xl font-bold text-gray-900 mb-3">الاهتمامات</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="bg-gray-50 rounded-xl p-4">
                    ...
                    <p class="text-gray-900 font-medium">{profile.occupation}</p>
                </div>
                ...
                <div class="bg-gray-50 rounded-xl p-4">
                    ...
                    <p class="text-gray-900 font-medium">
                        {profile.maritalStatus === 'single' ? 'أعزب/عزباء' : 
                         profile.maritalStatus === 'divorced' ? 'مطلق/مطلقة' : 'أرمل/أرملة'}
                    </p>
                </div>
                ...
                {#if profile.languages && profile.languages.length > 0}
                    <div class="bg-gray-50 rounded-xl p-4">
                        ...
                        <p class="text-gray-900 font-medium">{profile.languages.join('، ')}</p>
                    </div>
                {/if}
                ...
                {#if profile.height}
                    <div class="bg-gray-50 rounded-xl p-4">
                        ...
                        <p class="text-gray-900 font-medium">{profile.height} سم</p>
                    </div>
                {/if}
            </div>
            ...
            <div class="flex gap-3 pt-4">
                ...
                <button
                    ...
                    class="w-14 h-12 flex items-center justify-center rounded-xl border-2 {isLiked ? 'border-pink-500 bg-pink-50 text-pink-500' : 'border-gray-200 text-gray-400 hover:text-pink-500 hover:border-pink-300'} transition-colors"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={isLiked ? "currentColor" : "none"} stroke="currentColor" stroke-width={isLiked ? "0" : "2"} class="w-6 h-6">
